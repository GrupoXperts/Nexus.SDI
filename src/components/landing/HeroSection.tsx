  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <nav className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-6 md:px-12 py-5">
        <img src={nexusLogo} alt="Nexus Protect" className="h-12 md:h-14" />
        <Button variant="cta-outline" size="sm" className="border-accent-foreground text-accent-foreground hover:bg-accent hover:text-accent-foreground">
          Contacto
        </Button>
      </nav>
